    ...
    <div className="relative flex flex-col h-full max-h-full">
      <div className="px-6 pt-4">
        ...
        <a
          ...
          href="../examples/html/scrollspy-sticky-sidebar.html"
          aria-label="Preline"
        >
          <svg
  ...
  <div className="lg:ps-[260px] ">
    <div className="min-h-[75rem] p-4 md:p-8">
      ...
      <div id="scrollspy" className="space-y-10 md:space-y-16">
        ...
        <div id="account" className="min-h-[25rem] scroll-mt-24">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
            Account
          </h2>
        </div>
        <div id="projects" className="min-h-[25rem] scroll-mt-24">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
            Projects
          </h2>
        </div>
        <div id="calendar" className="min-h-[25rem] scroll-mt-24">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
            Calendar
          </h2>
        </div>
        <div id="documentation" className="min-h-[25rem] scroll-mt-24">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
            Documentation
          </h2>
        </div>
        <div id="first" className="min-h-[25rem] scroll-mt-24">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
            First
          </h2>
        </div>
        <div id="second" className="min-h-[25rem] scroll-mt-24">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
            Second
          </h2>
        </div>
        <div id="third" className="min-h-[25rem] scroll-mt-24">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
            Third
          </h2>
        </div>
